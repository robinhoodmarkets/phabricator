...
final class PhabricatorOwnersPackageSlackTransaction
  extends PhabricatorOwnersPackageTransactionType {

  const TRANSACTIONTYPE = 'owners.slack';

  public function generateOldValue($object) {
    return $object->getSlackPathAttributes();
  }
  ...
  public function applyInternalEffects($object, $value) {
    $object->setSlackPathAttributes($value);
  }
  ...
  public function getTitle() {
    ...
    if ($new && $old) {
      return pht(
        '%s changed %s slack attribute(s), added %s: %s; removed %s: %s.',
        $this->renderAuthor(),
        $all_n,
        $add_n,
      ...
      return pht(
        '%s changed %s slack attribute(s), added %s: %s.',
        $this->renderAuthor(),
        $all_n,
        $add_n,
        $this->rendervalueList($add));
      ...
      return pht(
        '%s changed %s slack attribute(s), removed %s: %s.',
        $this->renderAuthor(),
        $all_n,
        $rem_n,
        $this->rendervalueList($rem));
